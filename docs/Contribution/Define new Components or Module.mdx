...
* **type** : 
1. type : string 
2. value: [List of resources](Add%20new%20AWS%20service.mdx) suppoted by Rover
...
**Resource List** : List of resources in [component](Define%20new%20Components%20or%20Module#component-structure) format
```JSON
"Module Name":{
    "Stack1 name":{
        "Resource List":[
