...
### Resources
Resources has all modules, components and their logics defined in [rover format](Contribution/Define%20new%20Components%20or%20Module.mdx),and it also has functions which converts modules and components to SAM template.
